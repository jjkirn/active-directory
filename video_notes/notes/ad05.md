...
## - John speed runs through the Kali install in the video so below are my steps:
...
## First, lets prepare the DC1 with random users
...
---
## Switch to Kali 
## cd ~/Desktop/active-directory/hacks/crackmapexec
```
...
```
## I also copyied all the passwords used by the "random_domain.ps1" script and put them into "passwords2.txt"
---
