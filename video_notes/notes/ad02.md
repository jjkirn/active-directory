...
## -- A login popup will appear -> enter the DC1 credentials (xyz\Administrator:P@ssw0rd123!)
...
## -- Get-ADUser -Filter * 
## -- Get-ADGroup -Filter *
## - I determined that I had to install Remote Server Administrator Tools (RSAT) on WS01 for this to work.
